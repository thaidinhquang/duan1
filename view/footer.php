			...
			<div class="modal-body p-5">
				...
				?>
					<div class="form-group">
						...
						<?= $user ?>
						<div class="form-group">
							<li><a href="index.php?act=mybill">Kiểm tra hóa đơn</a></li>
							<li><a href="index.php?act=quenmk">Quên mật khẩu</a></li>
							<li><a href="index.php?act=edit_taikhoan">Cập nhật tài khoản</a></li>
							<?php
							if ($role == 1) { ?>
								<li><a href="admin/index.php">Đăng nhap admin</a></li>
							<?php } ?>
						...
						<form action="index.php?act=dangnhap" method="post">
							...
							<div class="form-group">
								<div class="d-flex align-items-center justify-content-between">
									...
									<div class="eltio_k2">
										<a href="index.php?act=quenmk">Lost Your Password?</a>
									</div>
								</div>
							</div>

							<div class="form-group">
								<input type="submit" name="dangnhap" class="btn btn-md full-width bg-dark text-light fs-md ft-medium" value="Login">
							</div>

							<div class="form-group text-center mb-0">
								<p class="extra">Not a member?<a href="index.php?act=dangky" class="text-dark"> Register</a>
								</p>
							</div>
						</form>
					</div>
...
<!-- Mirrored from themezhub.net/kumo-demo-2/kumo/home-9.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Jul 2023 09:31:10 GMT -->
